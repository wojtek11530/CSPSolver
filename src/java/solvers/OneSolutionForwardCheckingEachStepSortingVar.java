...
public class OneSolutionForwardCheckingEachStepSortingVar<T> implements CSPSolver<T> {
    ...
    private boolean tryAssignValueToVariable() {
        ...
        while (domainIterator.hasNext()) {
            ...
            if (constraintsSatisfied) {
                ...
                if (noEmptyFilteredDomains) {
                    ...
                    boolean isSuccess = tryAssignValueToVariable();
                    if (isSuccess) {
                        return true;
                    } else {
